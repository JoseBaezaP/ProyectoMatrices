...
/**
 * Clase ModeloMatriz clase para validar y enviar los resultados de las
 * operaciones de matrices a la vista de la aplicacion.
 *
 * @author carlosavila
...
public class ModeloMatriz {
    ...
    /**
     * Variable publica: MatrizResultante modelo para generar la matriz
     * resultante de manera visual
     */
    public DefaultTableModel MatrizResultante = new DefaultTableModel();

    /**
     * <p>
     * metodo que devuelve el modelo de la MatrizA
     *
    ...
    /**
     * <p>
     * metodo que devuelve el modelo de la MatrizB
     *
    ...
    /**
     * <p>
     * metodo que devuelve el modelo de la MatrizResultante
     *
     * @return MatrizResultante modelo de la MatrizResultante que almacena los
     * resultados de las operaciones con la MatrizA y la MatrizB
     */
    ...
    /**
     * <p>
     * Metodo que establece el modelo de la MatrizA
     *
    ...
    /**
     * <p>
     * Metodo que establece el modelo de la MatrizB
     *
    ...
    /**
     * <p>
     * Metodo que establece el modelo de la MatrizResultante
     *
     * @param MatrizResultante modelo de la MatrizResultante con los valores a
     * establecer
     */
    ...
    /**
     * <p>
     * Metodo que valida que se cumplan las condiciones para que se pueda
     * calcular la suma y la multiplicacion
     *
    ...
    /**
     * <p>
     * Metodo que valida que se cumplan las condiciones para que se puedan
     * reealizar las operaciones con una matriz
     *
    ...
    /**
     * <p>
     * Metodo que genera la MatrizA de manera visual en una tabla
     *
    ...
    /**
     * <p>
     * Metodo que genera la MatrizB de manera visual en una tabla
     *
     * @param fila numero de filas de la matriz
     * @param columna numero de columnas de la matriz
     */
    ...
    /**
     * <p>
     * Metodo que genera la MatrizResultado de manera visual en una tabla
     *
     * @param fila numero de filas de la matriz
     * @param columna numero de columnas de la matriz
     */
